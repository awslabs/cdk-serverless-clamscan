...
* **props** (<code>[ServerlessClamscanProps](#cdk-serverless-clamscan-serverlessclamscanprops)</code>)  A `ServerlessClamscanProps` interface.
  ...
  * **efsProvisionedThroughputPerSecond** (<code>[Size](#aws-cdk-lib-size)</code>)  Set the provisioned throughput of the EFS file system (Default: null). __*Optional*__
  * **efsThroughputMode** (<code>[aws_efs.ThroughputMode](#aws-cdk-lib-aws-efs-throughputmode)</code>)  Set the throughput mode of the EFS file system (Default: BURSTING). __*Optional*__
...
**efsProvisionedThroughputPerSecond**? | <code>[Size](#aws-cdk-lib-size)</code> | Set the provisioned throughput of the EFS file system (Default: null).<br/>__*Optional*__
**efsThroughputMode**? | <code>[aws_efs.ThroughputMode](#aws-cdk-lib-aws-efs-throughputmode)</code> | Set the throughput mode of the EFS file system (Default: BURSTING).<br/>__*Optional*__
