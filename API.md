...
* **props** (<code>[ServerlessClamscanProps](#cdk-serverless-clamscan-serverlessclamscanprops)</code>)  A `ServerlessClamscanProps` interface.
  ...
  * **efsProvisionedThroughputPerSecond** (<code>[Size](#aws-cdk-lib-size)</code>)  Provisioned throughput for the EFS file system. __*Optional*__
...
**efsProvisionedThroughputPerSecond**? | <code>[Size](#aws-cdk-lib-size)</code> | Provisioned throughput for the EFS file system.<br/>__*Optional*__
